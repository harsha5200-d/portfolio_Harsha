...
import { FaPrint, FaArrowLeft, FaEnvelope, FaPhone, FaMapMarkerAlt, FaGithub, FaLinkedin, FaExternalLinkAlt } from 'react-icons/fa';
      ...
      <div className="max-w-4xl mx-auto mb-8 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-250/60 dark:border-slate-800 shadow-sm flex flex-wrap gap-4 items-center justify-between no-print">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-medium text-slate-500 dark:text-slate-400">
            ATS-Friendly PDF Mode
          </span>
        </div>
        
        <button
          onClick={handlePrint}
          className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-sm cursor-pointer transition-all"
        >
          <FaPrint className="text-xs animate-pulse" />
          <span>Print or Save PDF (Ctrl+P)</span>
        </button>
      </div>
