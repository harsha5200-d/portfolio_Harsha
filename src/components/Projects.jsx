              ...
              .map((project) => (
                ...
                >
                  <div className="p-6 md:p-8">
                    ...
                    {/* Description */}
                    <p className="text-slate-650 dark:text-slate-350 text-sm mt-3 leading-relaxed">
                      {project.description}
                    </p>
                    ...
                    <div className="mt-6 space-y-2">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-450 mb-3">
                        Key Features
                      </h4>
                      {project.features.map((feature, idx) => (
                        <div key={idx} className="flex gap-2 text-xs text-slate-650 dark:text-slate-400">
                  ...
                  {/* Footer Links */}
                  <div className="p-6 md:px-8 border-t border-slate-100 dark:border-slate-800/60 bg-slate-50/50 dark:bg-slate-900/50 flex items-center gap-4">
                    <a
                      href={project.github}
                      target="_blank"
