        ...
        >
          {profiles.map((profile, idx) => (
            <motion.a
              ...
              whileHover={{ y: -5 }}
              className="relative overflow-hidden p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/80 shadow-sm hover:shadow-md flex items-center justify-between group transition-all duration-300"
            >
              {/* Profile details */}
              ...
              {/* Arrow link */}
              <span className="p-2 rounded-lg bg-slate-50 dark:bg-slate-850 text-slate-450 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
