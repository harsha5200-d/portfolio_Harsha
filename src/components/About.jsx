        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="relative group w-64 h-64 sm:w-80 sm:h-80">
              ...
              {/* Card Container */}
              <div className="absolute inset-0 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center p-4 shadow-xl overflow-hidden">
                <svg
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              <h3 className="text-xl md:text-2xl font-bold text-slate-850 dark:text-slate-100 mb-4">
              ...
              <p className="text-slate-600 dark:text-slate-350 leading-relaxed text-base mt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {highlights.map((hl, idx) => (
                <motion.div
                  ...
                  whileHover={{ y: -3 }}
                  className="flex gap-4 p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-sm"
                >
                  <div className="text-2xl mt-1 shrink-0 p-2 rounded-lg bg-slate-50 dark:bg-slate-850">
                    {hl.icon}
                  </div>
                  <div>
                    <h4 className="font-semibold text-sm text-slate-800 dark:text-white">{hl.title}</h4>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-normal">{hl.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
