        ...
        <div className="relative border-l border-slate-200 dark:border-slate-800 ml-4 md:ml-12 pl-8 md:pl-12 space-y-12">
          {educationData.map((edu, idx) => (
            ...
            >
              ...
              {/* Timeline Card */}
              <div className="p-6 md:p-8 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow">
                ...
                {/* Meta details */}
                <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-slate-500 dark:text-slate-450 mt-4 pt-4 border-t border-slate-100 dark:border-slate-850/60">
