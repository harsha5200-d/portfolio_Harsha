      ...
      <div className="max-w-4xl mx-auto text-center z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-800 dark:bg-slate-800/80 dark:text-blue-300 dark:border dark:border-slate-700/60 mb-6 shadow-sm"
          >
          ...
          <motion.p 
            variants={itemVariants}
            className="text-sm md:text-base font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-widest"
          >
            Hi, my name is
          </motion.p>
          ...
          <motion.p 
            variants={itemVariants}
            className="text-base sm:text-lg text-slate-600 dark:text-slate-350 max-w-2xl mt-6 leading-relaxed"
          >
