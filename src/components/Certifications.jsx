        ...
        >
          {certificationsData.map((cert, idx) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800 shadow-sm flex flex-col hover:shadow-md transition-all duration-300"
            >
              ...
              {/* Description */}
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-4 leading-relaxed flex-grow">
                {cert.description}
              </p>
